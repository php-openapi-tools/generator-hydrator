...
final class Aliases extends TestCase
{
    public static function assert(File ...$files): void
    {
        ...
        self::assertStringContainsString('public function getObjectMapperOperation🌀Root() : \ApiClients\Client\GitHub\Aliases\Internal\Hydrator\Operation\Root', $files['Internal\Hydrators']->contents);
        ...
        self::assertStringContainsString('(array $payload): \\\\ApiClients\Client\GitHub\Aliases\Schema\Root', $files['Internal\Hydrator\Operation\Root']->contents);
    }
}
