...
final class Aliases implements GeneratedFilesAssertion
{
    ...
    public static function assertGeneratedFiles(array $files): void
    {
        ...
        Assert::assertStringContainsString('public function getObjectMapperOperation🌀Root(): \ApiClients\Client\GitHub\Aliases\Internal\Hydrator\Operation\Root', GeneratedFiles::contents($files, 'Internal\Hydrators'));
        ...
        Assert::assertStringContainsString('(array $payload): \\ApiClients\Client\GitHub\Aliases\Schema\Basic', GeneratedFiles::contents($files, 'Internal\Hydrator\Operation\Root'));
    }
}
